...
insert into public.organizational_positions (
...
) values ('f6c00000-0000-0000-0000-0000000000a1', 'f6a00000-0000-0000-0000-0000000000a1',
   'f6b00000-0000-0000-0000-0000000000a1', 'f6d00000-0000-0000-0000-000000000001', null,
   '2025-01-01T00:00:00Z', null, 'F6 P4.5 01-cenario-f3-04 posição funcional'),
  ...
  ('f6c00000-0000-0000-0000-0000000000aa', 'f6a00000-0000-0000-0000-0000000000a1',
   ...
   '2025-01-01T00:00:00Z', '2025-06-30T00:00:00Z', 'F6 P4.5 01-cenario-f3-04 posição funcional');

-- Posições — Beta
insert into public.organizational_positions (

  id, organization_id, unit_id, job_role_id, seniority_level_id, valid_from, valid_to, name
) values ('f6c00000-0000-0000-0000-0000000000b1', 'f6a00000-0000-0000-0000-0000000000b1',
