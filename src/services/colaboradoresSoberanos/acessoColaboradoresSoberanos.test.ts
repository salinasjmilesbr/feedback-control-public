...
function servicoFalso(
  ...
  const padrao: ServiceColaboradores = {
    ...
    renomearPosicao: (entrada) => registrar("renomearPosicao", entrada, 4),
...
const CASOS_DA_PORTA: readonly CasoDaPorta[] = [
  ...
  {
    nome: "trocarOcupacao",
    metodo: "trocarOcupacao",
    chamar: (deps) => porta.trocarOcupacao(ENTRADAS.trocarOcupacao, deps),
    argumentos: ENTRADAS.trocarOcupacao,
  },
  {
